...
export const UNISWAP_WEB_HOSTNAME = 'app.sunminyswap.org'
...
const helpUrl = 'http://support.Anarkoswap.org'
// const helpUrl = 'http://localhost:3000'
...
export const uniswapUrls = {
  ...
  helpArticleUrls: {
    ...
    contractAddressExplainer: `${helpUrl}`,
    ...
    lpIncentiveInfo: `${helpUrl}`,
    fiatOnRampHelp: `${helpUrl}`,
    fiatOffRampHelp: `${helpUrl}`,
    transferCryptoHelp: `${helpUrl}`,
    mobileWalletHelp: `${helpUrl}`,
    ...
    addingV4Hooks: `${helpUrl}`,
    routingSettings: `${helpUrl}`,
    v4HooksInfo: `${helpUrl}`,
